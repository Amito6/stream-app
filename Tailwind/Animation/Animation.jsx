    ...
    const design = (
        <>
            <div className="overflow-hidden relative">
                ...
                dots ?
                    <div className="absolute bottom-0 left-0 p-5  w-full flex justify-center">
            ...
            style={{
                ...
                flex items-center`}>
                    <div className="px-4 text-white">
                        ...
                        <Button 
                        className="flex items-center gap-2 text-xs px-3 mt-3 rounded-lg"
                        theme="error">
